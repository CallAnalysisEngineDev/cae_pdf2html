...
public class TransformTaskFactory {
	...
	public static ITransformTask getTransformTask(String fileName,TransformHandler handler){
		...
		if(operationSystem.startsWith("Windows")){
			return new WindowsTransformTask(fileName, container.getDestDir(), container.getDataDir(), handler);
		}
		return null;
	}
}
